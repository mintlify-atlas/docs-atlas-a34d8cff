...
description: "Manage thermal printer hardware actions — paper feed, paper cut, acoustic beep, and cash drawer pulse — using dedicated sections in your print job."
---
